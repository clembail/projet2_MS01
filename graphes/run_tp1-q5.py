...
cpp_executable = "../build/tp1-ex2CG" # Nom de votre C++ compilé

plt.figure(figsize=(10, 7))

# 2. Boucle pour exécuter le C++
for h, mesh_file in meshes.items():
    csv_file = f"results_h_{h}.csv"
...
plt.savefig("question_5_plot.png")
print("Graphique 'question_5_plot.png' sauvegardé.")
