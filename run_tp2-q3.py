...
print("--- Analyse pour la Question 6 du TP1 ---")
...
iter_valuesCG = [r[1] for r in results]

print("--- Analyse pour la Question 3 du TP2 ---")

# 1. Trouver tous les fichiers de résultats
csv_files = glob.glob("./results_PCG/results_h_*.csv")
results = []
...
# 2. Trier les résultats par h pour un joli tracé
results.sort(key=lambda x: x[0])
iter_valuesPCG = [r[1] for r in results]
...
print("Graphique 'question_6_plot.png' sauvegardé.")
